...
export function createMangaSchema(manga: any) {
    return {
        ...
        '@type': 'Book',
        '@id': `https://dfk-team.com/manga/${manga.slug}`,
        name: manga.title,
        ...
        publisher: {
            ...
            logo: {
                '@type': 'ImageObject',
                url: 'https://dfk-team.com/logo.png' // أضف لوجو الموقع
            }
        },
        ...
        url: `https://dfk-team.com/manga/${manga.slug}`
    };
}
...
export function createChapterSchema(chapter: any, manga: any) {
    return {
        '@context': 'https://schema.org',
        '@type': 'Article',
        '@id': `https://dfk-team.com/manga/${manga.slug}/chapter/${chapter.slug}`,
...
export function createWebsiteSchema() {
    return {
        ...
        potentialAction: {
            ...
            target: {
                '@type': 'EntryPoint',
                urlTemplate: 'https://dfk-team.com/search?q={search_term_string}'
            },
...
export function createOrganizationSchema() {
    return {
        '@context': 'https://schema.org',
        '@type': 'Organization',
        '@id': 'https://dfk-team.com/#organization',
        name: 'DFK Team',
        url: 'https://dfk-team.com',
        logo: {
            '@type': 'ImageObject',
            url: 'https://dfk-team.com/logo.png'
        },
